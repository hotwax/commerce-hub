<template>
  <ion-list>
    ...
    <ion-item>
      ...
      <ion-select :value="appliedFilters.category" @ionChange="updateFilters($event['detail'].value, 'category')" interface="popover">
    ...
    <ion-item>
      ...
      <ion-select :value="appliedFilters.size" @ionChange="updateFilters($event['detail'].value, 'size')" interface="popover">
    ...
    <ion-item>
      ...
      <ion-select :value="appliedFilters.color" @ionChange="updateFilters($event['detail'].value, 'color')" interface="popover">
...
export default defineComponent({
  ...
  methods: {
    async updateFilters(value: string, filterName: string) {
      if (value === this.appliedFilters[filterName]) {
        return ;
      }
