...
export const PRODUCT_CATEGORIES_UPDATED = SN_PRODUCT + 'CATEGORIES_UPDATED'
export const PRODUCT_CATEGORY_CURRENT_UPDATED = SN_PRODUCT + '/CATEGORY_CURRENT_UPDATED'